...
Fase Free com biblioteca inicial jogável: portal aberto, sem cadastro, sem anúncios e com cinco jogos. O desenvolvimento ocorre somente na máquina local.
...
- Máquina local: desenvolvimento e testes.
- GitHub privado: código-fonte e histórico de versões.
...
- Droplet, Nginx e Cloudflare: serão avaliados apenas na futura implantação.
...
- `docs/PLANO_JOGOS_FASE_FREE.md`: especificação dos cinco jogos da biblioteca inicial.
